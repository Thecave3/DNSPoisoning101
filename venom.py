...
def dns_query_builder(url, query_id="1") -> bytes:
    ...
    This function creates a dns package with customizable parameters. This allows you to send dns queries directly
    from the program. The function uses the struct library to facilitate string to byte conversion to store the
    entire contents of the package before the conversion.  This function returns the dns data in the form of byte
    stream.
...
def main():
    ...
    dns_query = dns_query_builder("www.andrealacava.com")
